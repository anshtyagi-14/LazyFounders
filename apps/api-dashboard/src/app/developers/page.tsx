      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            {[
              { id: 'discovery', number: '1', title: 'Discovery', endpoint: '/api/v1/discovery', accent: 'from-teal-400 to-teal-600', badge: 'bg-teal-500/15 text-teal-400', curl: `curl -X POST ${typeof window !== 'undefined' ? window.location.origin : 'https://your-domain.com'}/api/v1/discovery \\\n  -H "Authorization: Bearer YOUR_API_KEY" \\\n  -H "Content-Type: application/json" \\\n  -d '{"url":"https://example.com"}'` },
              { id: 'scraper', number: '2', title: 'Scraper', endpoint: '/api/v1/scrape', accent: 'from-blue-400 to-blue-600', badge: 'bg-blue-500/15 text-blue-400', curl: `curl -X POST ${typeof window !== 'undefined' ? window.location.origin : 'https://your-domain.com'}/api/v1/scrape \\\n  -H "Authorization: Bearer YOUR_API_KEY" \\\n  -H "Content-Type: application/json" \\\n  -d '{"url":"https://example.com/article"}'` },
              { id: 'categorize', number: '3', title: 'Categorization AI', endpoint: '/api/v1/categorize', accent: 'from-purple-400 to-purple-600', badge: 'bg-purple-500/15 text-purple-400', curl: `curl -X POST ${typeof window !== 'undefined' ? window.location.origin : 'https://your-domain.com'}/api/v1/categorize \\\n  -H "Authorization: Bearer YOUR_API_KEY" \\\n  -H "Content-Type: application/json" \\\n  -d '{"text":"Raw scraped article text..."}'` },
              { id: 'intelligence', number: '4', title: 'Intelligence AI', endpoint: '/api/v1/intelligence', accent: 'from-amber-400 to-amber-600', badge: 'bg-amber-500/15 text-amber-400', curl: `curl -X POST ${typeof window !== 'undefined' ? window.location.origin : 'https://your-domain.com'}/api/v1/intelligence \\\n  -H "Authorization: Bearer YOUR_API_KEY" \\\n  -H "Content-Type: application/json" \\\n  -d '{"text":"Article text...", "category":"Finance"}'` },
            ].map((api) => (
